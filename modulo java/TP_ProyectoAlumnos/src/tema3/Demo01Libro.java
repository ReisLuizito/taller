...
public class Demo01Libro {
    ...
    public static void main(String[] args) {
        ...
        autor.setNombre("Herbert Schildt");
        autor.setBiografia("Autor estadounidense de computación y lenguajes de programación (Java, C++, C#). Ex-tecladista de la banda Starcastle");
        autor.setOrigen("Estados Unidos");
